...
spark = SparkSession.builder.appName("sparkpyeventskafkastream").getOrCreate()
...
kafkaStreamingDF.withColumn("value",from_json("value",riskSchema)).select(col('value.*')).createOrReplaceTempView("CustomerRisk")
